...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Ticker>().HasData(
            new Ticker { Id = 1, Symbol = "AAPL", CompanyName = "Apple Inc", Exchange = "NASDAQ" },
            new Ticker { Id = 2, Symbol = "NVDA", CompanyName = "NVIDIA Corporation", Exchange = "NASDAQ" },
            new Ticker { Id = 3, Symbol = "MSFT", CompanyName = "Microsoft Corporation", Exchange = "NASDAQ" },
            new Ticker { Id = 4, Symbol = "TSLA", CompanyName = "Tesla Inc", Exchange = "NASDAQ" },
            new Ticker { Id = 5, Symbol = "AMZN", CompanyName = "Amazon.com Inc", Exchange = "NASDAQ" },
            new Ticker { Id = 6, Symbol = "META", CompanyName = "Meta Platforms Inc", Exchange = "NASDAQ" },
            new Ticker { Id = 7, Symbol = "GOOGL", CompanyName = "Alphabet Inc", Exchange = "NASDAQ" },
            new Ticker { Id = 8, Symbol = "AMD", CompanyName = "Advanced Micro Devices", Exchange = "NASDAQ" },
            new Ticker { Id = 9, Symbol = "SPY", CompanyName = "SPDR S&P 500 ETF", Exchange = "NYSE" },
            new Ticker { Id = 10, Symbol = "QQQ", CompanyName = "Invesco QQQ Trust", Exchange = "NASDAQ" }
        );
    }
}